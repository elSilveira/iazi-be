...
export const createServiceValidator = [
  ...
  body("category").trim().notEmpty().withMessage("A categoria do serviço é obrigatória."),
...
export const updateServiceValidator = [
  ...
  body("category").optional().trim().notEmpty().withMessage("A categoria do serviço é obrigatória."),

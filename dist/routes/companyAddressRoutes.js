...
const authMiddleware_1 = require("../middlewares/authMiddleware"); // Corrected import name
const validationMiddleware_1 = require("../middlewares/validationMiddleware"); // Corrected import path
const router = (0, express_1.Router)();
// Route to get company address (Public or authenticated? Assuming public for now)
router.get("/:companyId", companyAddressValidators_1.companyAddressIdValidationRules, validationMiddleware_1.validateRequest, companyAddressController.getCompanyAddress);
// Route to create or update company address (Requires authentication and likely specific permissions)
router.put("/:companyId", authMiddleware_1.authMiddleware, // Use correct middleware name
// Add specific permission middleware here if needed (e.g., check if user owns the company)
companyAddressValidators_1.companyAddressValidationRules, validationMiddleware_1.validateRequest, companyAddressController.upsertCompanyAddress);

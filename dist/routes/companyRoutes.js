...
router.post("/", ...companyValidators_1.createCompanyValidator, validationMiddleware_1.validateRequest, (0, asyncHandler_1.asyncHandler)(companyController_1.createCompany));
